          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                autoFocus
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm font-mono tracking-widest text-center text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 uppercase"
                disabled={loading}
              />
            </div>
